...
web_urlpatterns = [
    ...
    path('receipt/<str:transaction_number>/', views.receipt_detail, name='receipt_detail'),
...
api_urlpatterns = [
    ...
    path('price-adjustments/<str:item_code>/dismiss/', views.api_dismiss_price_adjustment, name='api_dismiss_price_adjustment'),
]
